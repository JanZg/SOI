...
struct proc {
  ...
  int licznik_starv;	/* SOI Lab 2 Zmienna licznika do zaglodzenia procesu */  
  int cnt;
...
#define PRIO_OFF	 0	/* Subpriority unused*/
#define PRIO_NORMALNY	 1	/* Normal process subpriority*/
#define PRIO_TLO 	 2	/* Background process subpriority */
...
/*#SOI #PROJECT1 */
#define isemptysp(p)      ((p)->p_subpriority == PRIO_OFF)
#define isnormalsp(p)     ((p)->p_subpriority == PRIO_NORMALNY)
#define isbackgroundsp(p) ((p)->p_subpriority == PRIO_TLO)
/*---------*/
